...
public class SignUpInstrumentedTest {
    ...
    public void showErrorMessageUser(){
        scenario = FragmentScenario.launchInContainer(SignupFragment.class, new Bundle(),
               R.style.Theme_MaterialComponents);

        onView(allOf(supportsInputMethods(),
                isDescendantOfA(withId(R.id.TextField_username_register))))
                .perform(typeText("3435"));
        closeSoftKeyboard();
